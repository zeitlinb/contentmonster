...
- **6.4 (agent)** 7 keywords (50 chars, 2–3-word phrases, not duplicating the title) + up to **3 categories per format** from the browse tree. Disambiguate "AI Chief of Staff" hard from "Chief AI Officer". ⚠ 3-category cap is firm (the email-for-10 option was removed in 2023).
...
- **10.3 (Brad)** Drive Brad's audiences to **BUY** the $0.99 launch (velocity → rank), then raise to $4.99. ⚠ **NEVER solicit reviews** from list/network/household/beta readers — fastest suspension path. Selling to them is fine; reviewing is not.
